...
<main>
    <div class="admin_page view_user_manag edit_user_manag">
        <?php include("./sidebar.php"); ?>
        <div class="page">
            <div class="page_head">
                <h1>
                <img src="assets/images/back_arrow.svg" alt="" class="back_arrow">Edit User Management
                                        ...
                                        <div class="img_or_btns">
                                            ...
                                            <div class="ae_btn">
                                                ...
                                                <div class="common_btn2">
                                                    <a href="./view_user_managment.php">Cancel</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="u_info">
